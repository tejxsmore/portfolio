export const project = [
  ...
  },
  {
    ...
    img: "/img/anime.png",
    description:
      "Super Anime is a anime streaming platform. Here users can enjoy all the trending animes across different genres and can read their previous review",
    tech: ["Next", "Tailwind", "React"],
    link: "https://superanime.vercel.app",
    git: "https://github.com/tejxsmore/superanime",
  },
  {
    id: 2,
    title: "Blogifyi",
